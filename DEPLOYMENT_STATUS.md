...
- **Status:** Running
- **URL:** https://absrulered2-d7hcgtadawaqaren.centralus-01.azurewebsites.net/
...
**Root Cause:** 
- Workflow was trying to access `https://ABSRuleRed2.azurewebsites.net/`
- Actual Azure URL is `https://absrulered2-d7hcgtadawaqaren.centralus-01.azurewebsites.net/`
- Azure generates a unique hostname format in certain regions
